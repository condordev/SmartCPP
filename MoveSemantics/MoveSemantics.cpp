...
/* another example from https://stackoverflow.com/questions/5481539/what-does-t-double-ampersand-mean-in-c11 
...
public:
	...
	{  // steal s's resources
		...
		s.size = 0;
        std::cout << "Move constructor called on rvalue." << std::endl;
	}
	...
	Sample& operator=(const Sample& s)
	{
        ...
        std::cout << "Copy Assignment called on lvalue." << std::endl;
		return *this;
	}
	...
	Sample& operator=(Sample&& lhs)
	{
        ...
        std::cout << "Move Assignment called on rvalue" << std::endl;
		return *this;
	}
	//...snip
};
